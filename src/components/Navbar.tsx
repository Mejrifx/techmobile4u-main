...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 w-full border-b border-white/20 bg-background/80 backdrop-blur-md supports-[backdrop-filter]:bg-background/50">
